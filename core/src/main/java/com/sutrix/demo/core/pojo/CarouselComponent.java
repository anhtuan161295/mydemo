...
public class CarouselComponent extends WCMUsePojo {
    ...
    public Carousel parseCarousel(ResourceResolver resourceResolver, PageManager pageManager, String pagePath) {
        ...
        try {
            ...
            String imgPath =  page.getPath() + "/jcr:content/image/file/jcr:content/dam:thumbnails/dam:thumbnail_60.png";
            carousel.setDesktopImgPath(imgPath);
            carousel.setMobileImgPath(imgPath);
